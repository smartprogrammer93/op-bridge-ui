...
// Constants
const MIN_DEPOSIT_ETH = 0.0001;
const GAS_RESERVE_ETH = 0.005; // Reserve for L1 gas
...
function validateAmount(
  ...
  if (parsed < MIN_DEPOSIT_ETH) {
    return `Minimum deposit is ${MIN_DEPOSIT_ETH} ETH`;
  }
    ...
    <div className="w-full max-w-lg mx-auto">
      ...
      <div className="relative bg-[#12121a]/80 backdrop-blur-xl rounded-2xl border border-white/5 p-6 shadow-2xl">
        ...
        {validationError && amount && (
          <div id="amount-error" className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center gap-2">
